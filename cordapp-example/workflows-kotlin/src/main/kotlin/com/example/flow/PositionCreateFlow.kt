 ...
 */
object PositionCreateFlow {
    @InitiatingFlow
    @StartableByRPC
    class Initiator(val position: Position,
        ...
        override fun call(): SignedTransaction {
            ...
            val positionState = PositionState(position, serviceHub.myInfo.legalIdentities.first(), otherParty)
            val txCommand = Command(PositionContract.Commands.Create(), positionState.participants.map { it.owningKey })
            val txBuilder = TransactionBuilder(notary)
                    .addOutputState(positionState, PositionContract.ID)
